    ...
    <div class="login">
      ...
      {/* <div className="text-white sm:py-8 lg:py-">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <form
            className="mx-auto max-w-lg rounded-lg login-form"
            method="post"
            onSubmit={loginData}
          >
            <div className="flex flex-col gap-4 p-4 md:p-8">
              ...
              <div className="relative flex items-center justify-center">
                <span className="relative  px-4 text-sm ">
                  Log in with social
                </span>
              </div>
            ...
            <div className="flex items-center justify-center bg-slate-900 p-4">
              <p className="text-center text-sm ">
                ...
                <a
                  href="#"
                  className="text-blue-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700"
                >
                  Register
                </a>
              </p>
