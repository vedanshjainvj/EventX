  ...
  return (
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <a href="https://www.rgpv.ac.in/Campus/I_EPolicy.pdf" target='blank' class="items-center justify-center px-5 py-3 text-base font-medium text-center border border-gray-300 rounded-lg text-white">
                Speak to Sales
            </a> 
        </div>
