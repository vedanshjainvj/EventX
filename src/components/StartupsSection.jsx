  ...
  return (
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <Link to='/start-ups' href="#" class="inline-flex items-center justify-center bg-pink-700 px-5 py-3 mr-3 md:text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 text-sm dark:focus:ring-primary-900">
                Check Startups
