      ...
      <div className="flex w-full justify-between h-[90vh]">
        <div className="h-full p-3 space-y-2 dark:bg-gray-900 w-1/6">
          <div className="flex items-center p-2 space-x-4">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfR9MGB_ovrAGJ7mdZ4rFf_2-79XGG6yAIRA&usqp=CAU"
              alt=""
            ...
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              <li className="dark:text-gray-50">
                ...
                >
                  ...
                  <a href="#" class="">
                    <NavLink to="/AddEvent/id">Event Requests</NavLink>
                  </a>
                </a>
              </li>
              <li>
                ...
                >
                  ...
                  <NavLink to="/new-club-register">New Club Register</NavLink>
                </a>
              </li>
              <li>
                <a
        ...
        <div className="w-5/6 flex justify-center items-center">
          <img
            className="w-[80%]"
            src="https://bs-uploads.toptal.io/blackfish-uploads/uploaded_file/file/465203/image-1607186163027-08f7f301d7d9bc30bbb10ceed33134a0.gif"
            alt=""
          />
        </div>
      </div>
