        ...
        <div class="max-w-6xl mx-auto p-4 sm:px-6">
          <article class="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            <div>
              ...
              The Entrepreneurship Summit is the annual flagship event of E-Cell IIT Bombay, which is a confluence of visionary students, professionals or anybody who has passion f
              </p>
