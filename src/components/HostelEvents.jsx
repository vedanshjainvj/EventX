  ...
  return (
	...
	<div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-10 lg:flex-row lg:px-10 lg:justify-around">
		<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-[50%] xl lg:text-left">
			<h1 className="text-5xl font-bold leadi sm:text-6xl">Hostel Events : {" "} <br />
				<span className="dark:text-violet-400 text-5xl">Your Learning Place</span>
			</h1>
			...
			<div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
				<a rel="noopener noreferrer" href="#" className="px-8 py-3 text-lg font-semibold rounded dark:bg-pink-800 ">Upcoming {`${days}d ${hours}h ${minutes}m ${seconds}s`}</a>
		...
		<div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96">
			<img src="http://localhost:5173/src/assets/grpimg9.jpeg" />
		</div>
	</div>
</section>
    </>
