            ...
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <div class="club-cards p-6">
                ...
                <div className="flex gap-2 mt-4 social-links w-fit rounded-lg px-2">
                    ...
                    <h1 className="text-2xl"><a href="" target="_blank"><i class="ri-whatsapp-fill"></i></a></h1>
                </div>
              </div>
            </div>
            <div class="xl:w-1/4 md:w-1/2 p-4">
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
        ...
        <div class="relative py-6 px-6 rounded-3xl club-cards w-64 my-4 shadow-xl">
            <div class=" text-white flex items-center absolute card-div-bg rounded-full py-4 px-4 z-50 shadow-xl  left-4 -top-6">
                ...
                <img src={codehacklogo} className="object-contain object-center p-1 rounded-full h-12 border-2 border-blue-400" alt="" />
            </div>
            <div class="mt-8">
        ...
        <div class="relative py-6 px-6 club-cards rounded-3xl w-64 my-4 shadow-xl">
            ...
            <img src="https://logogen.gdscasu.com/logos/gdsc-logo.png" className="object-contain object-center border-2 p-2 border-blue-400 rounded-full h-12" alt="" />
            </div>
            <div class="mt-8">
        ...
        <div class="relative  py-6 px-6 rounded-3xl w-64 my-4 club-cards shadow-xl">
            ...
            <img src={codingwizlogo} className="object-contain mix-blend-difference border-2 p-2 border-blue-400 object-center rounded-full h-12" alt="" />
            </div>
            <div class="mt-8">
        ...
        <div class="relative  py-6 px-6 rounded-3xl w-64 my-4 club-cards shadow-xl">
            ...
            <img src="https://miro.medium.com/v2/resize:fit:2400/1*1bmmA88dVbYzsS-K6_FMgQ.png" className="border-2 p-2 border-blue-400 object-contain mix-blend-difference object-center rounded-full h-12" alt="" />
            </div>
            <div class="mt-8">
