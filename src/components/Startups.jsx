    ...
    <>
      <section class="px-12">
        <div class="container px-6 py-10 mx-auto">
          <h1 className="text-center text-5xl">Start-ups</h1>

          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
            {/* <span class="inline-block p-3 rounded-full dark:text-white"> */}
                <img className="h-6 w-6" src="https://media.licdn.com/dms/image/C560BAQHrSdTPixR0fQ/company-logo_200_200/0/1663773706856/boostem_logo?e=1706745600&v=beta&t=sJaPIeItkZ9aF73Ij6tea-C7Jy43s8n9e3NNys-0goM" alt="" />
              {/* </span> */}
