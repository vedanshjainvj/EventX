...
const Hod = () => {
  return (
    ...
    <section className="">
	<div className="container flex flex-col items-center justify-center p-4 mx-auto sm:pt-4">
		<div className="flex flex-row flex-wrap-reverse justify-center mt-8">
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://www.uitrgpv.ac.in/aboutdepartment/FacultyImages/PSC_300621025452.jpg" />
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leadi">Piyush Shukla</p>
					<p>Computer Science</p>
                    <h6 className='text-sm text-gray-900'>Exp - 22 Years</h6>
				</div>
				<div className="flex items-center justify-center p-2 space-x-3 border-t-2">
					<h1 className='text-sm text-gray-900'>aseemctiwari@rgtu.net</h1>
				</div>
			</div>
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://www.uitrgpv.ac.in/aboutdepartment/FacultyImages/PSC_300621025452.jpg" />
