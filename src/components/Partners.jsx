...
const Partners = () => {
  return (
    <>
    <section className="">
    <div className="py-16 lg:py-16 mx-auto max-w-screen-xl px-4">
        <h2 className="partners-h1 mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">OUR PARTNERS</h2>
