            ...
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              ...
              <li>
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="flex items-center p-2 space-x-3 rounded-md bg-gray-800"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  ...
                  <NavLink to="/students-data-record">
                      ...
                      <tbody class="bg-gray-800">
                        <tr class="bg-black bg-opacity-20">
                          ...
                          <td class="flex px-6 py-4 whitespace-nowrap">
                            <span class="ml-2 font-medium">Vedansh Jain</span>
                          </td>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">UIT</td>
                          <td class="px-6 py-4 whitespace-nowrap">CSE</td>
                          <td class="flex px-6 py-4 whitespace-nowrap">
                            <svg
