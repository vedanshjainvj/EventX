...
const Inzio = () => {
  ...
  <div class="container px-6 sm:px-0 py-16 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <iframe alt="ecommerce" class="inizio-video lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.youtube.com/embed/IUt2KEhqBcQ"/>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <p class="leading-relaxed">Here we are interacting with the freshers batch of UIT. The first batch to begin their college life virtually, share their views, ideas, expectations and hilarious experiences of the online classes in this crazy, candid conversation.</p>
