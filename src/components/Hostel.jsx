    ...
    <div class="flex flex-wrap -m-4 justify-center">
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          <img alt="team" class="flex-shrink-0 rounded-lg w-72 h-64 object-cover object-center sm:mb-0 mb-4" src="https://qph.cf2.quoracdn.net/main-qimg-8f0a0737d9b70e7ad2564238d288cb8f-lq"/>
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg">Bhaskaracharya Hostel</h2>
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          <img alt="team" class="flex-shrink-0 rounded-lg w-72 h-64 object-cover object-center sm:mb-0 mb-4" src="https://qph.cf2.quoracdn.net/main-qimg-8f0a0737d9b70e7ad2564238d288cb8f-lq"/>
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg">CV Raman Hostel</h2>
            <h3 class="text-gray-400 mb-3">Total Rooms : 90</h3>
            <p class="">Warden : Prof. Kaustubh Dwivedi </p>
            <p class="">Care Taker : Deependra Mishra </p>
            <p class="">Overall Rating : 6⭐ out of 10 stars</p>
...
<body class="flex items-center justify-center w-screen ">
	...
	<div class="flex flex-col w-full max-w-screen-md">
        <div class="flex items-center h-20 px-4 border-b border-gray-500">
            ...
            <div class="flex-grow text-lg font-semibold text-center">Medium</div>
