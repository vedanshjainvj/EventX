  ...
  return (
	...
	<div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-10 lg:px-0 lg:flex-row lg:px-10 lg:justify-around">
		<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-[50%] xl lg:text-left">
			<h1 className="text-5xl font-bold leadi sm:text-6xl">Senior - Junior {" "} <br />
				<span className="dark:text-violet-400 text-5xl">The ultimate bond ❤️</span>
			</h1>
		...
		<div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
			<img src="http://localhost:5173/src/assets/grpimg6.jpeg" alt="" className="object-contain h-72 lg:rounded-xl sm:h-80 lg:h-96 xl:h-112 2xl:h-128" />
		</div>
	</div>
</section>
    </>
